"""
Flask Server for PestVid with Frontend Serving
This version serves both the API endpoints and the frontend static files
"""
...
print("=" * 60)
print("🌱 PestVid Full Stack Server Starting...")
print("=" * 60)
print("This server provides:")
print("✅ Frontend serving (HTML, CSS, JS)")
...
def home():
    ...
    return jsonify({
        'status': 'running',
        'message': 'PestVid Full Stack Server',
        'version': '1.0',
        'available_endpoints': [
            '/api/simple-ai-advice',
...
@app.route('/api/simple-ai-advice', methods=['POST'])
...
@app.route('/api/seasonal-advice', methods=['POST'])
...
def chat():
    ...
    return jsonify({
        ...
        'alternative': 'Use /api/simple-ai-advice endpoint for agricultural questions'
    }), 501

if __name__ == '__main__':
    print("\n🚀 Full stack server starting on http://localhost:5000")
    print("🌐 Frontend: http://localhost:5000/")
    print("🔧 API: http://localhost:5000/api/")
    print("📝 Test API with: curl http://localhost:5000/api/quick-tips")
    print("=" * 60)
